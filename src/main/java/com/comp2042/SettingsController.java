...
public class SettingsController {
     ...
     */
    void init(Main mainApp, GameMode returnToGameMode) {
    ...
    private void startEditingKey(Button button, String actionName) {
        ...
        if (button.getScene() != null) {
            ...
            final java.util.concurrent.atomic.AtomicReference<javafx.event.EventHandler<javafx.scene.input.KeyEvent>> handlerRef = 
                new java.util.concurrent.atomic.AtomicReference<>();
            
            javafx.event.EventHandler<javafx.scene.input.KeyEvent> keyHandler = event -> {
            ...
            button.getScene().addEventFilter(javafx.scene.input.KeyEvent.KEY_PRESSED, keyHandler);
        }
    }
